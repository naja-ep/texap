...
const ClientFeedbackStyle1 = ({ feedbacks }) => {
        ...
        <div className="feedback-area ptb-100">
          <div className="container">
            <div className="section-title">
              <span className="sub-title">{feedbacks.subTitle}</span>
                  ...
                  <div className="single-feedback-box" key={itemInfo.id}>
                    <div className="client-info">
                      <div className="d-flex align-items-center">
                        <img src={itemInfo.image.url} alt={itemInfo.image.alternativeText} />
                        <div className="title">
                          <h3>{itemInfo.name}</h3>
                    ...
                    <div className="rating d-flex align-items-center justify-content-between">
                      ...
                      <div>
                        {itemInfo.rating.slice(0, 5).map((star) => (
                          <i className={star.starIcon} key={star.id}></i>
                        ))}
                      </div>
                    </div>
                  </div>
